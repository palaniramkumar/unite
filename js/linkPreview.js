				...
				$.get('../class/highlightUrls.php', {
					...
					content = '<div class="previewPosted">' + '<div class="previewTextPosted">' + urls.urls + '</div>' + videoIframe + '<div class="previewImagesPosted">' + '<div class="previewImagePosted">' + leftSideContent + '</div>' + '</div>' + '<div class="previewContentPosted">' + '<div class="previewTitlePosted" id="' + pTP + '" ><a href="' + hrefUrl + '" target="_blank">' + title + '</a></div>' + '<div class="previewUrlPosted">' + fancyUrl + '</div>' + '<div class="previewDescriptionPosted" id="' + pDP + '" >' + urls.description + '</div>' + '</div>'  + '</div>';					$('#preview').fadeOut("fast", function() {
						...
						$('#previewDescription').html("");
                                                ...
                                                //alert("../activity/_Activity.php?action=addvideo&&msg="+content);
                                                $.ajax({
                                                    url: "../activity/_Activity.php?action=addvideo&&msg="+content,
                                                    type: "POST",
                                                    cache: false
                                                })
                                                        .done(function(html) {
