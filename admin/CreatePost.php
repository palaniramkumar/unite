    ...
    <body>
                ...
                <div class="col-xs-12 col-sm-9" >
                    ...
                    <nav class="navbar navbar-default" role="navigation">
                        ...
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand"  id="heading">Create Post</a>
                        </div>
        ...
        //jquery upload
                    ...
                    function ShowAllPost() {
                        ...
                        $.ajax({
                            url: "_post.php?action=getallpost&filter=All",
                            type: "POST",
                            cache: false
                        })
                                .done(function(html) {
                    ...
                    function DeletePost(id) {
                        ...
                        $.ajax({
                            url: "_post.php?action=deletepost&id="+id,
                            type: "POST",
                            cache: false
                        })
                                .done(function(html) {
                    ...
                    function TogglePost(id) {
                        ...
                        $.ajax({
                            url: "_post.php?action=togglepost&id="+id,
                            type: "POST",
                            cache: false
                        })
                                .done(function(html) {
                    ...
                    function EditPost(id) {
                        ...
                        $.ajax({
                            url: "_post.php?action=editpost&id="+id,
                            type: "POST",
                            cache: false
                        })
                                .done(function(html) {
