...
// oauth2_client_id, oauth2_client_secret, and to register your oauth2_redirect_uri.
 $client->setClientId('100558720107.apps.googleusercontent.com');
 $client->setClientSecret('Vx2BfJ16uUv2s8_ANWHCT17a');
 $client->setRedirectUri('http://ssnunite.com/class/googleAPI/googleOAUTH.php');
 $client->setDeveloperKey('100558720107@developer.gserviceaccount.com');
...
if ($client->getAccessToken()) {
  ...
  $db = new dbConnection();
    ...
    $db->validateOAUTH($email,$name,"Google"); 
