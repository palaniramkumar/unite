<?php /* Smarty version 2.6.26, created on 2012-10-12 16:19:06
...
" ><?php echo $this->_tpl_vars['navigation']['footer3'][$this->_sections['tmp']['index']]['name']; ?>
			...
			Proudly powered by <a href="http://www.jobberbase.com/" title="open source job board software">JobberBase</a><br/>
				Site is Proudly Maintained By GARC 
			</div>
			<div class="clear"></div>
		</div><!-- #footer-contents -->
	</div><!-- .footer -->
